...
public struct GameState: Hashable, Codable {
    ...
    static var game: GameState = GameState(group_id: 1234, is_playing: true, num_teams: 3, turn: 2, game_name: "cribbage", num_players: 6, dealer: 0, team_with_crib: 1, crib: Array(0...3), cards: Array(29...51).shuffled(), starter_card: 4, player_turn: 0)
