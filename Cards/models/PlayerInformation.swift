...
public struct PlayerInformation: Hashable, Codable {
    ...
    static let player_one = PlayerInformation(name: "Daniel", uid: "001", player_num: 0, cards_in_hand: [CardItem(id: 0, card: "DJ"), CardItem(id: 1, card: "D9"), CardItem(id: 2, card: "S6"), CardItem(id: 3, card: "H6"), CardItem(id: 0, card: "DJ"), CardItem(id: 1, card: "D9"), CardItem(id: 2, card: "S6"), CardItem(id: 3, card: "H6")], is_lead: true, team_num: 1)
